...
public class WonderlandAttractionBuilder extends AttractionBuilder {

    public WonderlandAttractionBuilder(Attraction attraction) {
    ...
    public Attraction build() {
        System.out.println("Wonderland attraction created! Get ready for fun!");
        return attraction;
    }
}
